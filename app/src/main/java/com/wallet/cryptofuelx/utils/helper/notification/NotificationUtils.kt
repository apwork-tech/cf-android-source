...
object NotificationUtils {
    ...
    private val notificationChannelRepository =
            EnumMap<NotificationType, NotificationChannelDetails>(NotificationUtils.NotificationType::class.java)

    init {
        notificationChannelRepository[NotificationUtils.NotificationType.DEFAULT] =
