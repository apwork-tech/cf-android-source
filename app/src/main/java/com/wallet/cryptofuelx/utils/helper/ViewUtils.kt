...
import com.wallet.cryptofuelx.main.data.local.model.SelectionTrackerParameters
import com.wallet.cryptofuelx.main.ui.base.callback.ItemClickListener
import com.wallet.cryptofuelx.main.ui.base.callback.ItemLongClickListener
import com.wallet.cryptofuelx.main.ui.base.component.BaseAdapter
import com.wallet.cryptofuelx.main.ui.base.component.BaseItemDetailsLookup
import com.wallet.cryptofuelx.main.ui.base.component.BaseSelectableAdapter
import com.wallet.cryptofuelx.main.ui.base.helper.SwipeItemHandler
...
class ViewUtils {
    companion object {
        ...
        /**
         * This function takes String and generate qr code and return image bitmap
         */
        fun getQrCodeBitmap(inputValue: String): Bitmap? {
            var bitmap: Bitmap? = null
            var qrgEncoder = QRGEncoder(inputValue, null,
