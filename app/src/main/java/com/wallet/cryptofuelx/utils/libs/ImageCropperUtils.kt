...
import com.wallet.cryptofuelx.utils.helper.FileUtils
import com.wallet.cryptofuelx.utils.helper.imagepicker.ImagePickerUtils
import com.wallet.cryptofuelx.utils.libs.ImageCropperUtils.mCroppedImage
import com.wallet.cryptofuelx.utils.libs.ImageCropperUtils.mListener
...
object ImageCropperUtils {
    ...
    fun cropImage(activity: Activity, sourceUri: Uri, listener: Listener) {
        ...
        if (destinationUri != null) {
            ...
            cropImage(activity, null, sourceUri, destinationUri,
                    ImageCropperUtils.CropRatio.DEFAULT)
        }
    }
    ...
    private fun cropImage(activity: Activity?,
        ...
        when (cropRatio) {
            ...
            ImageCropperUtils.CropRatio.SQUARE -> {
                cropper.withAspectRatio(1.toFloat(), 1.toFloat())
            }

            ImageCropperUtils.CropRatio.WIDE -> {
                cropper.withAspectRatio(16.toFloat(), 9.toFloat())
            }

            ImageCropperUtils.CropRatio.EXTRA_WIDE -> {
                cropper.withAspectRatio(18.toFloat(), 9.toFloat())
            }

            ImageCropperUtils.CropRatio.REGULAR -> {
